...
from controls.headers import header_profile
...
class RecommendationsPage:
    ...
    def __init__(self, screen):
        ...
        self.icon_return = ft.Icon(ft.icons.ARROW_BACK)
    ...
    def build(self):
        profile_txt = header_profile()
        return_button = CircleButtonBase(content=self.icon_return,
                                          on_click=self.on_click_return)
        header = ft.Row(controls=[profile_txt, return_button],
